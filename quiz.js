...
class EnhancedQuizApp {
    ...
    // Mobile-specific gesture and touch handling
    setupMobileGestures() {
        ...
        // Handle touch move
        this.quizContainer.addEventListener('touchmove', (e) => {
        ...
        // Handle touch end
        this.quizContainer.addEventListener('touchend', (e) => {
            if (!isSwiping) return;
    ...
    addTouchFeedback() {
        ...
        const buttons = document.querySelectorAll('.btn, .nav-btn, .option');
